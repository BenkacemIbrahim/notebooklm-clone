...
export function HeroSection() {
  return (
    <section id="hero" className="mx-auto max-w-6xl px-6 py-20 text-center md:px-8 md:py-32">
      ...
      <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto text-balance font-helvetica">
        Your research and thinking partner, grounded in the information you trust, built with modern
